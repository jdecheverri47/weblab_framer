    ...
    <section className="overflow-hidden h-screen" ref={sectionRef} id="home">
      ...
      >
        ...
        <motion.p
          ...
          className="xl:text-3xl text-center lg:mt-4 xl:max-w-3xl text-[#958ea7] text-lg tracking-tighter"
        >
        ...
        <motion.a initial={{ opacity: 0 }}
            ...
            viewport={{ once: true }}
            transition={{ duration: 1.2, delay: 1.5 }} className="text-white lg:px-9 lg:py-3 rounded-full gradient_button_navbar hover:text-opacity-60 transition-all duration-300 ease-in-out lg:text-xl tracking-tighter lg:mt-10 text-lg mt-4 py-3 px-7" href='#pricing'>
          Get started
        </motion.a>
      </div>
    </section>
